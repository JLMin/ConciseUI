...
local LOC_ORGANIZE_GREAT_WORKS = Locale.Lookup(
                                     "LOC_GREAT_WORKS_ORGANIZE_GREAT_WORKS")
...
function GetThemeDescription(buildingType)
    ...
    local bAutoTheme = localPlayer:GetCulture():IsAutoThemedEligible(
                           GameInfo.Buildings[buildingType].Hash)
...
function PopulateGreatWorkSlot(instance, pCity, pCityBldgs, pBuildingInfo)
    ...
    if (numSlots ~= nil and numSlots > 0) then
        ...
        if firstGreatWork ~= nil and themeDescription ~= nil and buildingType ~=
            "BUILDING_QUEENS_BIBLIOTHEQUE" then
            ...
            if themeDescription ~= nil then
                ...
                if numSlots > 1 then
                    if (bAutoTheme == true) then
                        instance.ThemingLabel:SetText(
                            Locale.Lookup(
                                "LOC_GREAT_WORKS_THEME_BONUS_PROGRESS",
                                numGreatWorks, numSlots))
                    else
                        instance.ThemingLabel:SetText(
                            Locale.Lookup(
                                "LOC_GREAT_WORKS_THEME_BONUS_PROGRESS",
