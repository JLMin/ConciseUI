                        ...
                        table.insert(
                            ...
                            "[COLOR:Civ6Red](" ..
                                Locale.Lookup("LOC_TOOLTIP_REQUIRES") ..
                                    " " .. Locale.Lookup(techType.Name) .. ")[ENDCOLOR]"
                        )
                    end
                end
            end
                ...
                if (localPlayer ~= nil) then
                    ...
                    if (civicType ~= nil and not playerCulture:HasCivic(civicType.Index)) then
                        table.insert(
                            ...
                            "[COLOR:Civ6Red](" ..
                                Locale.Lookup("LOC_TOOLTIP_REQUIRES") ..
                                    " " .. Locale.Lookup(civicType.Name) .. ")[ENDCOLOR]"
                        )
                    end
                end
            end
...
function ChangeToMidFog(plotIndex)
    ...
    if (pIconSet ~= nil) then
        ...
        pIconSet.RecommendationIcon:SetHide(
            (not m_isShowRecommendations) or (not pIconSet.RecommendationIconTexture:HasTexture())
        )
