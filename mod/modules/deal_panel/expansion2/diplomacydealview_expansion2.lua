...
function PopulatePlayerAvailablePanel(rootControl, player)
    local playerType = GetPlayerType(player)
    local iAvailableItemCount =
        PopulateAvailableFavor(player, g_AvailableGroups[AvailableDealItemGroupTypes.FAVOR][playerType])
...
function PopulateAvailableFavor(player, iconList)
    ...
    local possibleResources =
        DealManager.GetPossibleDealItems(eFromPlayerID, eToPlayerID, DealItemTypes.FAVOR, pForDeal)
