...
local ScreenshotMode = {
  FULLY_HIDE = { "/InGame/WorldViewControls",
                 --
                 "/InGame/HUD",
  ...
  KEEP_CITY  = { "/InGame/WorldViewIconsManager",
...
-- ===========================================================================
ScreenshotInputHandler[MouseEvents.RButtonUp] =
  function (uiKey) return true; end
;
...
function Initialize()
  ...
  Controls.ScreenshotButton:RegisterCallback( Mouse.eRClick, function() EnterScreenshotMode(ScreenshotMode.KEEP_CITY); UI.PlaySound("Play_UI_Click"); end );
end
Initialize();