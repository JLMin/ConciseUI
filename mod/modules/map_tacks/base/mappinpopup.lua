...
function MapPinIsVisibleToChatTarget(mapPinVisibility, chatPlayerTarget)
    ...
    elseif (mapPinVisibility == ChatTargetTypes.CHATTARGET_TEAM) then
        ...
        elseif
            (chatPlayerTarget.targetType == ChatTargetTypes.CHATTARGET_PLAYER and
                chatPlayerTarget.targetID ~= NO_PLAYERTARGET_ID)
         then
    ...
    elseif (mapPinVisibility >= 0) then
        ...
        if
            (chatPlayerTarget.targetType == ChatTargetTypes.CHATTARGET_PLAYER and
                mapPinVisibility == chatPlayerTarget.targetID)
         then
            return true
        end
    end
...
function OnMapPinPlayerInfoChanged(playerID)
    PlayerTarget_OnPlayerInfoChanged(
        playerID,
        Controls.VisibilityPull,
        nil,
        nil,
        g_visibilityTargetEntries,
        g_playerTarget,
        true
    )
end
...
function Initialize()
    ...
    Controls.DeleteButton:RegisterCallback(
        Mouse.eMouseEnter,
        function()
    ...
    Controls.SendToChatButton:RegisterCallback(
        Mouse.eMouseEnter,
        function()
            UI.PlaySound("Main_Menu_Mouse_Over")
        end
    ...
    Controls.OkButton:RegisterCallback(
        Mouse.eMouseEnter,
        function()
            UI.PlaySound("Main_Menu_Mouse_Over")
        end
